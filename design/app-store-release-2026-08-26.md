...
Final read-only store verification: 2026-08-26 22:01 UTC (27 August,
00:01 in Warsaw). Release code: `6497e51d22451f11ef16b9b130349f1d130e9103`.
...
- The final candidate is selected on the draft store version. This selection
  is not a claim of physical-device acceptance or a review submission.
...
- Published App Privacy answers remain unverified and require the owner's
  App Store Connect UI check/publication. A policy URL alone is insufficient.
- Version 1.0 remains `PREPARE_FOR_SUBMISSION`; no App Review submission.
  The API returns no review submissions. Existing automatic release after
  approval is retained under the owner's
...
No confirmation of those three outstanding gates has been received yet.
