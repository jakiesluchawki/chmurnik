...
> Auto-generated on 2026-06-16 10:06. Do not edit manually.
...
- **Task 0006**: [Build an active METAR and TAF training workshop](lore/1-tasks/active/0006_FEATURE_metar-taf-training/README.md) — blocks 0 tasks (low)

## Task Status

| ID | Title | Type | Status | Blocked By | Blocks | ADRs |
|:---|:------|:-----|:-------|:-----------|:-------|:-----|
| 0006 | [Build an active METAR and TAF train...](lore/1-tasks/active/0006_FEATURE_metar-taf-training/README.md) | FEATURE | **active** | — | — | — |
