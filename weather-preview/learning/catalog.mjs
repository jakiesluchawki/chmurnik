...
export const activities = {
  ...
  front: {
    ...
    controls: [range("progress", "Wymuszone uniesienie", 0, 100, 1, "%", "height"), moisture, stability,
    ...
    steps: [step("progress", 70, "Unieś wilgotną porcję", "Unieś do 70% drogi", "Porcja ochładza się podczas unoszenia. Po przejściu poziomu kondensacji pojawia się chmura.", "W tym doświadczeniu ruch jest wymuszony. Nawet stabilne otoczenie nie wyklucza chmury, gdy działa unoszenie."),
      ...
      step("stability", "unstable", "Porównaj temperaturę z otoczeniem", "Wybierz chwiejne otoczenie", "Porównaj dwa termometry. Cieplejsza od otoczenia porcja ma dodatnią wyporność.", "Chwiejność może podtrzymać unoszenie, ale ten schemat nie oblicza głębokości konwekcji ani wystąpienia burzy. W swobodnej próbie możesz też zamienić front na zbocze.")],
