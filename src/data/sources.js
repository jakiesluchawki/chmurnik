export const sources = {
  ...
  wmoMotherNames: {
    id: "wmoMotherNames",
    organization: "World Meteorological Organization",
    title: "Mother-clouds and special clouds: abbreviations",
    label: "WMO: zapis nazw pochodzenia",
    url: "https://cloudatlas.wmo.int/en/abbr-and-symbols-of-clouds-table-mother-special.html",
    kind: "Tabela nazewnictwa",
    trust: "Oficjalna tabela łacińskich określeń pochodzenia chmur i ich skrótów.",
    scope: "Pisownia nazw zakończonych na genitus i mutatus. Przypisanie do rodzajów podaje osobna tabela klasyfikacji WMO.",
    checkText: "Mother-clouds and special clouds",
    retrieved: "5 września 2026",
  },
  nwsSpotterGlossary: {
    id: "nwsSpotterGlossary",
    organization: "NOAA / National Weather Service",
    title: "Weather Glossary for Storm Spotters",
    label: "NWS: lej i tornado",
    url: "https://www.weather.gov/oun/spotterglossary",
    kind: "Słownik obserwacji burz",
    trust: "Słownik amerykańskiej służby meteorologicznej dla obserwatorów zjawisk burzowych.",
    scope: "Różnica między widocznym lejem kondensacyjnym a wirem sięgającym powierzchni. Widoczny lej nie musi sięgać ziemi, by występowało tornado.",
    checkText: "Funnel Cloud",
    retrieved: "5 września 2026",
  },
  wmoSpecialClouds: {
    id: "wmoSpecialClouds",
